...
const projects = [
  {
    ...
    how:
      "1. 논문 데이터 수집 : 웹 크롤링과 API를 통하여 논문 자동 수집\n 2. 학술 키워드 정제 및 태깅 : 각 논문을 대표하는 정제된 학술 키워드를 추출 및 부여\n 3. 태그기반 검색 시스템과 시계열, 네트워크 데이터 분석/시각화로 인터렉티브한 분석결과 제공",
  ...
  },
  {
    ...
    how:
      "1. 기존의 쓰기 불편하고 안이쁜 원형계획표앱 대신 그리듯이 드래그로 원형계획표를 생성.\n2. 계획한 일정이 끝나면 자동으로 기록이 남고, 기록된 시간을 분석할 수 있도록 인터렉티브한 데이터 시각화 구현. \n 3. 추상적인 시간이라는 요소를 시각적으로 구현함으로써 시간의 흐름에 대한 인식 강화",
    tags: ["Android", "데이터 시각화", "UXUI 기획", "1인 개발"],
    role: "1인 개발 (기획, 개발, 유지, 관리)",
    detail_role: [
      "처음 안드로이드 앱을 개발.",
      "하나의 서비스를 배포하고 유저에게 피드백을 받아 서비스 개선, 유지, 관리하는 경험",
      "유저입장에서 서비스를 만드는 어려움과 중요성을 느낌 : 유저는 정말 다양하고, 약간의 UX 차이가 유저의 경험을 굉장히 좌우함"
    ],
    techstack: ["Android Studio(java)", "D3.js", "SQLite"],
    why: "",
    new:
      "처음 안드로이드 앱을 개발하고, 하나의 서비스를 런칭, 유저에게 피드백을 받.",
    learn:
  ...
  },
  {
    ...
    object:
      "기후변화로 인한 어류데이터의 변화를 분석하여 국가 사이의 가능한 교류 네트워크를 찾고 시각화.",
    how:
